 ...
 * see it in. Pending review sits on the far right of the same row, because it
 * is the one tab that asks something of you rather than showing you a pile.
 */
export default function ThoughtsBrowser({
  ...
  // while the review queue is up — it has no views to switch between.
  useEffect(() => {
